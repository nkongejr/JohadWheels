...
import { Eye, Fuel, Settings, Calendar, MapPin, Gauge, Car, BadgeCheck } from 'lucide-react';
  ...
  return (
    <Link href={`/cars/${car._id}`} className="block h-full">
      <div
        ...
        onMouseEnter={(e) => {
          e.currentTarget.style.borderColor = car.isSold
            ? 'rgba(16,185,129,0.5)'
            : 'rgba(232,25,44,0.4)';
          e.currentTarget.style.boxShadow = car.isSold
        ...
        >
          ...
          {car.isSold && (
            <div className="absolute inset-0 flex items-center justify-center">
              <div
                className="font-black text-white text-2xl tracking-widest px-8 py-2"
                style={{
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-1.5">
            {car.isSold ? (
              // Show sold badge when sold
              <span
                className="flex items-center gap-1 text-xs font-bold px-2.5 py-0.5 rounded"
                style={{
              ...
              // Show normal badges when available
              <>
                {car.isFeatured && (
                  <span
        ...
        <div className="p-4 flex flex-col flex-1">
          ...
          <div className="mb-3">
            <h3 className="font-bold text-white text-lg leading-tight">
              {car.brand}{' '}
              <span
                style={{ color: car.isSold ? '#10b981' : '#E8192C' }}
              >
                {car.model}
              </span>
            </h3>
          ...
          >
            ...
            >
              {car.isSold ? 'View Details' : 'View Details'}
