      ...
      >
        <div className="absolute inset-0 z-0 overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(90deg, #E8192C, #ff4d5e, #E8192C)',
            }}
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="flex flex-col md:flex-row gap-3">
                  ...
                  <select
                    ...
                    className="rounded-lg px-4 py-3 text-sm min-w-[160px] focus:outline-none"
                    style={{
                      background: '#f8fafc',
                      border: '1px solid #e2e8f0',
                      color: '#1e2d3d',
            ...
            <div className="relative hidden lg:block">
              <div
                ...
                style={{ border: '3px solid rgba(232,25,44,0.15)' }}
              >
                <Image
                  src="/images/tx.jpeg"
                  alt="Prado TX"
              ...
              <div
                ...
                style={{ border: '2px dashed rgba(232,25,44,0.15)' }}
              />
              <div
                className="absolute -z-10 top-16 right-16 w-52 h-52 rounded-full"
                style={{ border: '2px solid rgba(232,25,44,0.08)' }}
              />
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-end justify-between mb-10">
            ...
            <Link
              ...
              style={{ border: '1px solid #E8192C', color: '#ff4d5e' }}
            >
              View All Vehicles →
            </Link>
          </div>
          ...
          <div className="text-center mt-10">
            <Link
              href="/inventory"
              className="btn-red px-10 py-3 rounded-lg font-bold inline-block"
            >
              View All Vehicles
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                Since 2022, JOHAD WHEELS has been Kenya&apos;s premier
                destination for luxury vehicles. We specialize in sourcing,
                verifying, and selling premium automobiles from leading
                manufacturers including BMW, Mercedes-Benz, Audi, Porsche,
                and Range Rover.
              </p>
              <p className="text-gray-400 leading-relaxed mb-8">
                Our mission is to make luxury car ownership accessible to
                discerning Kenyan buyers through transparent pricing,
                flexible financing options, and exceptional customer service.
              </p>
              ...
              <Link
                href="/about"
                className="btn-red px-8 py-3 rounded-lg font-bold inline-block"
              >
                Learn More
              </Link>
            </div>
              ...
              <form onSubmit={handleContactSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full rounded-lg px-4 py-3 text-white placeholder-gray-500 text-sm focus:outline-none"
                      style={{
                        background: '#162030',
                        border: '1px solid #1e2d3d',
                      }}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={4}
                    className="w-full rounded-lg px-4 py-3 text-white placeholder-gray-500 text-sm focus:outline-none resize-none"
                    style={{
                      background: '#162030',
                      border: '1px solid #1e2d3d',
                    }}
            ...
            <div className="space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="tel:0716296585"
                        className="text-gray-400 text-sm hover:text-red-400 block transition-colors"
                      >
                        0716 296 585
                      </a>
                      <a
              ...
              >
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="btn-red px-4 py-2.5 rounded-lg text-sm font-bold"
                  >
                    Subscribe
                  </button>
                </form>
