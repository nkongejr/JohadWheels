        ...
        <div className="max-w-7xl mx-auto px-4 py-10">
          ...
          {car.isSold && (
            ...
            >
              ...
              <Link
                href="/inventory"
                className="ml-auto shrink-0 px-4 py-2 rounded-xl text-xs font-bold"
                style={{
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-4">
                ...
                <div
                  ...
                  style={{
                    background: '#111111',
                    borderColor: car.isSold ? 'rgba(16,185,129,0.25)' : '#1f2937',
                  }}
                >
                  <div className="mb-2">
                  ...
                  >
                    <span
                      ...
                      style={{
                        background: car.isSold ? '#10b981' : car.isAvailable ? '#22c55e' : '#ef4444',
                      }}
                    />
                ...
                >
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      { label: 'Status', value: car.isSold ? '✅ Sold' : '🟢 Available' },
                    ].map((item) => (
                      <div
                        key={item.label}
                      ...
                      >
                        ...
                        <span
                          ...
                          style={{
                            color: item.label === 'Status' && car.isSold ? '#10b981' : 'white',
                          }}
                        >
                          {item.value}
                        </span>
